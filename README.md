...
<img src="Images/wave.png" alt="plot" style="width: 450px;"/>

Then, below are the extracted results as midi:

<img src="Images/wave2mid_1.png" alt="plot" style="width: 450px;"/>
...
Below are the lists of tracks for this music. These songs can be played on the Github file that I shared.
...
<img src="Images/Turandot_1.png" alt="plot" style="width: 450px;"/>
...
<img src="Images/Butterfield_2.png" alt="plot" style="width: 450px;"/>

Finally, repeat the process of continuation or the improvisation.

<img src="Images/Butterfield_4.png" alt="plot" style="width: 450px;"/>

As we can see, the piece looks more completed this time.

*Gansyth*

To get in touch with the GANSynth techniques, I decided to pick Toradot and Dies Irae Requiem to produce the Choral Orchestral version. I realized that GANSynth would produce this part of music that I needed.
...
<img src="Images/Spectrogram_Requiem" alt="plot" style="width: 450px;"/>

And another is the CQT Spectrogram result for the Tudorat.

<img src="Images/Spectrogram_Tandorat" alt="plot" style="width: 450px;"/>
...
<img src="Images/Garageband.png" alt="plot" style="width: 450px;"/>
